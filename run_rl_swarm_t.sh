...
ORG_ID="23d53c30-8586-47f2-a37d-c6fa4ef713d4"
CONNECT_TO_TESTNET=true
HUGGINGFACE_ACCESS_TOKEN="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"
...
HF_TOKEN=""
HF_TOKEN="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"
if [ -n "${HF_TOKEN}" ]; then # Check if HF_TOKEN is already set and use if so. Else give user a prompt to choose.
    HUGGINGFACE_ACCESS_TOKEN=${HF_TOKEN}
else
    echo -en $GREEN_TEXT
    read -p ">> No HF Token provided " yn
    #echo -en $RESET_TEXT
